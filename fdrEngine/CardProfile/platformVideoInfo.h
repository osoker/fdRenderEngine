...
public:
   enum PVIQueryType
   {
      ...
      PVI_Description,        ///< std::string description of the adapter
...
private:
	std::vector<PVIAdapter> mAdapters; ///< Vector of adapters
...
protected:
   ...
   /// false otherwise. 
   virtual bool _queryProperty( const PVIQueryType queryType, const unsigned int adapterId, std::string *outValue ) = 0;
...
public:
   ...
   const PVIAdapter &getAdapterInformation( const unsigned int adapterIndex ) const;
};
