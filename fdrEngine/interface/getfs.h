...
extern CRITICAL_SECTION  g_sFileVisited;
...
//extern CRITICAL_SECTION  g_sFilename_lookup;
...
int           getfs_exists( const char* _filename );
	...
	//---------------------------------------------------------------------
	char* getfs_get_lastError();
	void getfs_set_lastError( const char* _errorText );
