...
/// const char* stName = StringTable->lookupn(name, len);
///
...
class OSENGINE_API _StringTable
{
private:
 ...
 //  DataChunker mempool;
  ...
  protected:
   static const unsigned int csm_stInitSize;
  ...
  public:
   ...
   const char* insert(const char *string, bool caseSens = false);
   ...
   /// @param  caseSens Determines whether case matters.
   const char* insertn(const char *string, int len, bool caseSens = false);
   ...
   /// @param  caseSens Determines whether case matters.
   const char* lookup(const char *string, bool caseSens = false);
   ...
   /// @param  caseSens Determines whether case matters.
   const char* lookupn(const char *string, int len, bool caseSens = false);
   ...
   static unsigned int hashString(const char* in_pString);

   /// Hash a string of given length into a U32.
   static unsigned int hashStringn(const char* in_pString, int len);
};


extern OSENGINE_API _StringTable *_gStringTable;

inline OSENGINE_API _StringTable* _getStringTable()
{
...
#define StringTableDestroy _StringTable::destroy()
