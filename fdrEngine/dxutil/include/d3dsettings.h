...
public:
    ...
    ose_VertexProcessingType Windowed_VertexProcessingType;
    ...
    ose_VertexProcessingType Fullscreen_VertexProcessingType;
    ...
    ose_VertexProcessingType GetVertexProcessingType() { return IsWindowed ? Windowed_VertexProcessingType : Fullscreen_VertexProcessingType; }
    void SetVertexProcessingType(ose_VertexProcessingType value) { if (IsWindowed) Windowed_VertexProcessingType = value; else Fullscreen_VertexProcessingType = value; }
