...
HRESULT CMusicManager::CreateSegmentFromMemory( CMusicSegment** ppSegment, BYTE* _dstart,int _dsize, 
								BOOL bDownloadNow, BOOL bIsMidiFile )
{
    ...
    objdesc.dwValidData = DMUS_OBJ_MEMORY | DMUS_OBJ_CLASS;
    objdesc.guidClass = CLSID_DirectMusicSegment;
    objdesc.llMemLength =(LONGLONG)_dsize;
    objdesc.pbMemData = (BYTE*)_dstart;
