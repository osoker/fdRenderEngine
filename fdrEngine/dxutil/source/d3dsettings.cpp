 ...
 *   River Get it from Dx9.0 Framework @ 4/14 2003.
 */
//-----------------------------------------------------------------------------
#define STRICT
# include "stdafx.h"
...
// Desc: Returns the string for the given ose_VertexProcessingType.
//-----------------------------------------------------------------------------
TCHAR* VertexProcessingTypeToString(ose_VertexProcessingType vpt)
{
    switch (vpt)
    {
    ...
    default:               return TEXT("Unknown ose_VertexProcessingType");
    }
}
...
void CD3DSettingsDialog::BackBufferFormatChanged( void )
{
    ...
    for( UINT idc = 0; idc < pDeviceInfo->pDeviceComboList->Count(); idc++ )
    {
            ...
            pDeviceCombo->BackBufferFormat == backBufferFormat)
        {
            ...
            {
                ose_VertexProcessingType vpt = *(ose_VertexProcessingType*)pDeviceCombo->pVertexProcessingTypeList->GetPtr(ivpt);
...
{
    ose_VertexProcessingType vpt = (ose_VertexProcessingType)PtrToUlong( ComboBoxSelected( IDC_VERTEXPROCESSING_COMBO ) );
